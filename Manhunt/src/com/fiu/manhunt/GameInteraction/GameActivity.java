...
public class GameActivity extends FragmentActivity implements LocationListener {
	...
	final Button taggedButton = (Button) findViewById(R.id.taggedButton); 
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//Tagged?
		taggedButton.setOnClickListener(new OnClickListener() {  
			@Override
			public void onClick(View v) { 
				new TransformToPredator().execute(""); 
			}
		});
    ...
    private class TransformToPredator extends AsyncTask<String, Void, String> {
    	 
        Button taggedButton = (Button) findViewById(R.id.taggedButton);
